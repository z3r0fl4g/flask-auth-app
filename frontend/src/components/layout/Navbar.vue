<template>
  <nav class="sticky top-0 z-50 backdrop-blur-lg bg-white/85 border-b border-white/70 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex h-18 items-center justify-between gap-6 py-3">
        ...
        <router-link to="/" class="flex items-center gap-3">
          ...
          <div class="hidden sm:block">
            ...
            <p class="text-[10px] tracking-[0.35em] uppercase text-gray-400">LIVE HAITIAN EVENTS</p>
          </div>
        </router-link>
        ...
        <template v-if="authStore.isAuthenticated && !hideNav">
          ...
          <div class="hidden md:flex items-center gap-8">
            <router-link to="/" class="flex flex-col items-center gap-1 text-gray-500 hover:text-gray-900 transition group">
            ...
            <router-link to="/profile" class="flex flex-col items-center gap-1 text-gray-500 hover:text-gray-900 transition group">
              <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative" ref="dropdownRef">
              ...
              >
                ...
                <img
                  ...
                  alt="Profile picture"
                >
                <span class="text-[11px] font-medium max-w-[100px] truncate">{{ authStore.user?.email }}</span>
              </button>
          ...
          <div class="md:hidden flex items-center">
            <button
              ...
              type="button"
              class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-700 shadow-sm hover:border-[#8338ec]/40 focus:outline-none focus:ring-2 focus:ring-[#8338ec]/40"
            >
        ...
        <template v-else-if="!hideNav">
          ...
          <div class="hidden lg:flex items-center gap-6 text-sm font-medium text-gray-600">
            <router-link to="/" class="hover:text-gray-900 transition">Discover</router-link>
            <a href="#schedule" class="hover:text-gray-900 transition">Live Events</a>
            <a href="#features" class="hover:text-gray-900 transition">How We Work</a>
            <a href="/ui-design" class="hover:text-gray-900 transition">Organizer Guide</a>
            <a href="#pricing" class="hover:text-gray-900 transition">Buy Tickets</a>
          </div>
      ...
      <div v-if="!hideNav && mobileMenuOpen" class="md:hidden pb-6">
        <div class="space-y-4 rounded-3xl border border-gray-200 bg-white p-6 shadow-lg shadow-gray-200/60">

          <!-- Authenticated mobile menu -->
          <template v-if="authStore.isAuthenticated">
            <nav class="space-y-1 text-sm font-medium text-gray-600">
              <router-link to="/" class="flex items-center gap-3 rounded-2xl px-4 py-3 hover:bg-gray-50 transition">
              ...
              <router-link to="/profile" class="flex items-center gap-3 rounded-2xl px-4 py-3 hover:bg-gray-50 transition">
                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                </svg>
                Tickets
          ...
          <template v-else>
            <nav class="space-y-2 text-sm font-medium text-gray-600">
              <router-link to="/" class="block rounded-2xl px-4 py-3 hover:bg-gray-50 transition">Discover</router-link>
              <a href="#schedule" class="block rounded-2xl px-4 py-3 hover:bg-gray-50 transition">Live Events</a>
              <a href="#features" class="block rounded-2xl px-4 py-3 hover:bg-gray-50 transition">How We Work</a>
              <a href="/ui-design" class="block rounded-2xl px-4 py-3 hover:bg-gray-50 transition">Organizer Guide</a>
            </nav>
